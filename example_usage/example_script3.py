...
The delta tables are stored in Azure Data Lake Storage Gen2 and this code snippet can be used in Databricks notebook.
'''
...
supplier_df.write.format("delta").mode("overwrite").saveAsTable("abfss://<container_name>@<storage_account_name>.dfs.core.windows.net/<folder_path>/supplier")
Product_df.write.format("delta").mode("overwrite").saveAsTable("abfss://<container_name>@<storage_account_name>.dfs.core.windows.net/<folder_path>/Product")
    ...
    "dependency_data_products" : [
        {
            ...
            "location" : "abfss://<container_name>@<storage_account_name>.dfs.core.windows.net/<folder_path>/Product"
        }
    ],
    "schema" : {
        "source_columns" : [
        ...
        "new_columns" : [
            {
                "name" : "Product_ID",
                "data_type" : "string",
                "sql_transformation" : "MERGE INTO {temp_std_dp_path} dest USING delta.`abfss://<container_name>@<storage_account_name>.dfs.core.windows.net/<folder_path>/Product` src ON dest.Product_Name = src.Product_Name WHEN MATCHED THEN UPDATE SET dest.Product_ID = src.Product_ID"
            }
        ]
    },
...
config_path = "abfss://<container_name>@<storage_account_name>.dfs.core.windows.net/<config path>"
...
raw_dp_path =  "abfss://<container_name>@<storage_account_name>.dfs.core.windows.net/<folder_path>/supplier"
temp_std_dp_path = "abfss://<container_name>@<storage_account_name>.dfs.core.windows.net/<folder_path>/Product_Supplier_temp"
std_dp_path = "abfss://<container_name>@<storage_account_name>.dfs.core.windows.net/<folder_path>/Product_Supplier"
